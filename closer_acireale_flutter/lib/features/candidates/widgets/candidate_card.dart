      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                if (Provider.of<AuthProvider>(context, listen: false).checkPermissionFromUser('candidates.update_all'))
                  Expanded(
                    child: CustomButton(
                      text: 'Modifica',
                      icon: Icons.edit,
                ...
                SizedBox(width: 8.w),
                if (Provider.of<AuthProvider>(context, listen: false).checkPermissionFromUser('candidates.delete_all'))
                  Expanded(
                    child: CustomButton(
                      text: 'Elimina',
                      icon: Icons.delete,
